...
int main()
{
    ...
    // ------------------------------------
    Shader cubeShader("Shaders/shader.vs.txt", "Shaders/shader.fs.txt");
    Shader lightShader("Shaders/light_shader.vs.txt", "Shaders/light_shader.fs.txt");
    ...
    */
    ...
    //Texture texObj1("Images/defense_towers.png", GL_TEXTURE_2D);
    //Texture texObj2("Images/defense_tower.png",GL_TEXTURE_2D);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindTexture(texObj1.texture_target(), texObj1.id());
        glActiveTexture(GL_TEXTURE1);
        glBindTexture(texObj2.texture_target(), texObj2.id());
        */
        cubeShader.use();
        cubeShader.setVec3("objectColor", {1.0f, 0.5f, 0.31f});
        cubeShader.setVec3("lightColor", {1.0f, 1.0f, 1.0f});
